...
DEFAULT_PATTERNS = (
    ...
    "research_v1_4_aggressive/kaggle_aggressive_v1_4_runtime_base.yaml",
    "research_v1_4_aggressive/comparison/*.csv",
    "research_v1_4_aggressive/comparison/*.json",
    "research_v1_4_aggressive/comparison/*.md",
    ...
    "research_v1_4_aggressive/experiments/*/outputs/experiment_results.csv",
    "research_v1_4_aggressive/experiments/*/outputs/samples/*overlay.png",
    "research_v1_4_aggressive/experiments/*/threshold_search/*.csv",
    "research_v1_4_aggressive/experiments/*/threshold_search/*.json",
    "research_v1_4_aggressive/experiments/*/threshold_search/*.md",
    "research_v1_4_aggressive/experiments/*/evaluation_*/*.csv",
